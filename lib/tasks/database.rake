...
#         middle_initial = name_array[1]
#       else
#         middle_initial = ""
#       end
#       if %w[de van von].include? name_array[-2] 
#         last_name = name_array[-2].sp(name_array[-1]) 
#       else
#         last_name = name_array[-1]
#       end
#       Author.find_or_create_by(first_name: first_name, middle_initial: middle_initial, last_name: last_name)
#     end
#   end
# end
