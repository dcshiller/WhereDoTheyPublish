...
function selectCategory (e) {
  ...
  if (e.target.dataset.name == "none") {
    ...
    var categoryMembers = document.querySelectorAll('.shown');
...
function hideAllElements (selector) {
  var elements = Array.prototype.slice.call(document.querySelectorAll(selector), 0);
...
//   var field = document.getElementById('authorFieldOne');
//   var nameSpan = document.getElementById('authorName');
