class TermSeederJob
  ...
  def self.set_terms(cat)
    terms = {
              ...
              em: %w[Epistemolo Externalism Internalism Epistemic Evidence Belief Credence Knowledge Empiricism Foundationalism Coherentism Probability Likelihood Parsimony Perception Memory Sensitivity Gettier Skeptic Bayesianism ],
              et: %w[Normative Motivation Egoism Wrongs Happiness Akratic Imperative Rawls Guilt Ought Killing Sidgwick Parfit Singer Externalism Internalism Friend Reason Akrasia Fair Evil Blame Life Deontic Moral Ethic Desert Consequentialism Value Rights Justice Good Wellbeing Punishment Obligation Obligatory Virtue Charity Utilitarianism Deontology],
